...
public class SerialPortActivity extends AppCompatActivity implements OnOpenSerialPortListener {
    ...
    public static final String BOTELV = "botelv";
    int botelv = -1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botelv = Integer.valueOf(getIntent().getStringExtra(BOTELV));
        ...
        boolean openSerialPort = mSerialPortManager.setOnOpenSerialPortListener(this)
                .setOnSerialPortDataListener(new OnSerialPortDataListener() {
                    ...
                    public void onDataReceived(byte[] bytes) {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Log.e("lichao", "接收:" + new String(finalBytes));
                ...
                .openSerialPort(device.getFile(), botelv);
